...
export function Component() {
  return (
    <Wrapper>
      <LineWaveBackground />
      {/* <div className="test col-center" style={{ margin: '0 auto', width: 260 }}>
        <Button size="lg">Medium</Button>
        <Button>Medium</Button>
        <Button size="sm">Medium</Button>
        <Button type="second">Medium</Button>
        <Button type="solid">Medium</Button>
        <Button type="text">Medium</Button>
        <Button type="third">Medium</Button>
        <Button type="third" disabled>
          Medium
        </Button>
        <Button type="third" loading>
          Medium
        </Button>
      </div> */}
